...
## Project Structure
    ...
    ├── innerdata_mobile_29346  # Django project configurations
...
1. Clone this repo and `cd innerdata_mobile_29346`
...
2. Clone this repo and `cd innerdata_mobile_29346`
